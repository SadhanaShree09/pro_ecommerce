...
</Fragment> : (!complete ? <h2 className="mt-5">Your Cart Is Empty!</h2> : <Fragment><h2 className="mt-5">Order Completed!</h2><p>Your order was placed successfully.</p></Fragment>)
}